...
function start(){
    ...
    setTimeout(() => {
        ...
        document.getElementById('continueFullScreen').style.display = 'block';
    }, 2200);
}
function fullScreenInfo(){
    ...
    document.getElementById('loading2').style.display = 'flex';
    document.getElementById('continueFullScreen').style.pointerEvents = 'none';
    setTimeout(() => {
        document.getElementById('loading2').style.opacity = '1';
        document.getElementById('loader2').style.animation = 'spin 0.8s linear infinite';
    }, 10);
    ...
    setTimeout(() => {
        document.getElementById('loading2').style.display = 'none';
        document.getElementById('loader2').style.animation = 'none';
        document.getElementById('continueFullScreen').style.display = 'none';
...
document.getElementById('audio1').onended = function() {
    ...
    setTimeout(() => {
        document.getElementById("lostConnectionWarning").style.display = "flex";
        document.getElementById('audio2').pause();
    }, 90000);
    setTimeout(() => {
        document.getElementById("lostConnectionWarning").style.display = "none";
        document.getElementById('audio2').play();
    }, 100000);
}
...
document.getElementById('audio3').onended = function() {
    ...
    setTimeout(() => {
        ...
        document.getElementById('timeRemainingReading').innerHTML = '35:00';
    }, 2200);
}
...
function p1q7a1(){
    document.getElementById('p1q7a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('p1q7a1').style.color = '#202020';
    document.getElementById('p1q7a2').style.backgroundColor = '#202020';
    document.getElementById('p1q7a2').style.color = '#F5F5DC';
    document.getElementById('p1q7a3').style.backgroundColor = '#202020';
    document.getElementById('p1q7a3').style.color = '#F5F5DC';
    document.getElementById('p1q7').value = 'a1';
}
function p1q7a2(){
    document.getElementById('p1q7a1').style.backgroundColor = '#202020';
    document.getElementById('p1q7a1').style.color = '#F5F5DC';
    document.getElementById('p1q7a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('p1q7a2').style.color = '#202020';
    document.getElementById('p1q7a3').style.backgroundColor = '#202020';
    document.getElementById('p1q7a3').style.color = '#F5F5DC';
    document.getElementById('p1q7').value = 'a2';
}
function p1q7a3(){
    document.getElementById('p1q7a1').style.backgroundColor = '#202020';
    document.getElementById('p1q7a1').style.color = '#F5F5DC';
    document.getElementById('p1q7a2').style.backgroundColor = '#202020';
    document.getElementById('p1q7a2').style.color = '#F5F5DC';
    document.getElementById('p1q7a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('p1q7a3').style.color = '#202020';
    document.getElementById('p1q7').value = 'a3';
}

function p1q8a1(){
    document.getElementById('p1q8a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('p1q8a1').style.color = '#202020';
    document.getElementById('p1q8a2').style.backgroundColor = '#202020';
    document.getElementById('p1q8a2').style.color = '#F5F5DC';
    document.getElementById('p1q8a3').style.backgroundColor = '#202020';
    document.getElementById('p1q8a3').style.color = '#F5F5DC';
    document.getElementById('p1q8').value = 'a1';
}
function p1q8a2(){
    document.getElementById('p1q8a1').style.backgroundColor = '#202020';
    document.getElementById('p1q8a1').style.color = '#F5F5DC';
    document.getElementById('p1q8a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('p1q8a2').style.color = '#202020';
    document.getElementById('p1q8a3').style.backgroundColor = '#202020';
    document.getElementById('p1q8a3').style.color = '#F5F5DC';
    document.getElementById('p1q8').value = 'a2';
}
function p1q8a3(){
    document.getElementById('p1q8a1').style.backgroundColor = '#202020';
    document.getElementById('p1q8a1').style.color = '#F5F5DC';
    document.getElementById('p1q8a2').style.backgroundColor = '#202020';
    document.getElementById('p1q8a2').style.color = '#F5F5DC';
    document.getElementById('p1q8a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('p1q8a3').style.color = '#202020';
    document.getElementById('p1q8').value = 'a3';
}
...
function Rp2q1a1(){
    ...
    document.getElementById('Rp2q1a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q1a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q1a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q1a4').style.color = '#F5F5DC';
...
function Rp2q1a3(){
    ...
    document.getElementById('Rp2q1a2').style.backgroundColor = '#202020';
    document.getElementById('Rp2q1a2').style.color = '#F5F5DC';
    document.getElementById('Rp2q1a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q1a3').style.color = '#202020';
    document.getElementById('Rp2q1a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q1a4').style.color = '#F5F5DC';
    document.getElementById('Rp2q1').value = 'a3';
}
function Rp2q1a4(){
    document.getElementById('Rp2q1a1').style.backgroundColor = '#202020';
    document.getElementById('Rp2q1a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp2q1a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q1a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q1a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q1a4').style.color = '#202020';
    document.getElementById('Rp2q1').value = 'a4';
}
...
function Rp2q2a1(){
    ...
    document.getElementById('Rp2q2a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q2a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q2a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q2a4').style.color = '#F5F5DC';
...
function Rp2q2a3(){
    ...
    document.getElementById('Rp2q2a2').style.backgroundColor = '#202020';
    document.getElementById('Rp2q2a2').style.color = '#F5F5DC';
    document.getElementById('Rp2q2a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q2a3').style.color = '#202020';
    document.getElementById('Rp2q2a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q2a4').style.color = '#F5F5DC';
    document.getElementById('Rp2q2').value = 'a3';
}
function Rp2q2a4(){
    document.getElementById('Rp2q2a1').style.backgroundColor = '#202020';
    document.getElementById('Rp2q2a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp2q2a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q2a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q2a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q2a4').style.color = '#202020';
    document.getElementById('Rp2q2').value = 'a4';
}
...
function Rp2q3a1(){
    ...
    document.getElementById('Rp2q3a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q3a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q3a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q3a4').style.color = '#F5F5DC';
...
function Rp2q3a3(){
    ...
    document.getElementById('Rp2q3a2').style.backgroundColor = '#202020';
    document.getElementById('Rp2q3a2').style.color = '#F5F5DC';
    document.getElementById('Rp2q3a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q3a3').style.color = '#202020';
    document.getElementById('Rp2q3a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q3a4').style.color = '#F5F5DC';
    document.getElementById('Rp2q3').value = 'a3';
}
function Rp2q3a4(){
    document.getElementById('Rp2q3a1').style.backgroundColor = '#202020';
    document.getElementById('Rp2q3a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp2q3a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q3a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q3a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q3a4').style.color = '#202020';
    document.getElementById('Rp2q3').value = 'a4';
}
...
function Rp2q4a1(){
    ...
    document.getElementById('Rp2q4a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q4a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q4a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q4a4').style.color = '#F5F5DC';
...
function Rp2q4a3(){
    ...
    document.getElementById('Rp2q4a2').style.backgroundColor = '#202020';
    document.getElementById('Rp2q4a2').style.color = '#F5F5DC';
    document.getElementById('Rp2q4a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q4a3').style.color = '#202020';
    document.getElementById('Rp2q4a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q4a4').style.color = '#F5F5DC';
    document.getElementById('Rp2q4').value = 'a3';
}
function Rp2q4a4(){
    document.getElementById('Rp2q4a1').style.backgroundColor = '#202020';
    document.getElementById('Rp2q4a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp2q4a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q4a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q4a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q4a4').style.color = '#202020';
    document.getElementById('Rp2q4').value = 'a4';
}
...
function Rp2q5a1(){
    ...
    document.getElementById('Rp2q5a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q5a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q5a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q5a4').style.color = '#F5F5DC';
...
function Rp2q5a3(){
    ...
    document.getElementById('Rp2q5a2').style.backgroundColor = '#202020';
    document.getElementById('Rp2q5a2').style.color = '#F5F5DC';
    document.getElementById('Rp2q5a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q5a3').style.color = '#202020';
    document.getElementById('Rp2q5a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q5a4').style.color = '#F5F5DC';
    document.getElementById('Rp2q5').value = 'a3';
}
function Rp2q5a4(){
    document.getElementById('Rp2q5a1').style.backgroundColor = '#202020';
    document.getElementById('Rp2q5a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp2q5a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q5a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q5a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q5a4').style.color = '#202020';
    document.getElementById('Rp2q5').value = 'a4';
}
...
function Rp2q6a1(){
    ...
    document.getElementById('Rp2q6a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q6a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q6a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q6a4').style.color = '#F5F5DC';
...
function Rp2q6a3(){
    ...
    document.getElementById('Rp2q6a2').style.backgroundColor = '#202020';
    document.getElementById('Rp2q6a2').style.color = '#F5F5DC';
    document.getElementById('Rp2q6a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q6a3').style.color = '#202020';
    document.getElementById('Rp2q6a4').style.backgroundColor = '#202020';
    document.getElementById('Rp2q6a4').style.color = '#F5F5DC';
    document.getElementById('Rp2q6').value = 'a3';
}
function Rp2q6a4(){
    document.getElementById('Rp2q6a1').style.backgroundColor = '#202020';
    document.getElementById('Rp2q6a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp2q6a3').style.backgroundColor = '#202020';
    document.getElementById('Rp2q6a3').style.color = '#F5F5DC';
    document.getElementById('Rp2q6a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp2q6a4').style.color = '#202020';
    document.getElementById('Rp2q6').value = 'a4';
}



function Rp3q1a1(){
    document.getElementById('Rp3q1a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q1a1').style.color = '#202020';
    document.getElementById('Rp3q1a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q1').value = 'a1';
}
function Rp3q1a2(){
    document.getElementById('Rp3q1a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q1a2').style.color = '#202020';
    document.getElementById('Rp3q1a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q1').value = 'a2';
}
function Rp3q1a3(){
    document.getElementById('Rp3q1a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q1a3').style.color = '#202020';
    document.getElementById('Rp3q1a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q1').value = 'a3';
}
function Rp3q1a4(){
    document.getElementById('Rp3q1a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q1a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q1a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q1a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q1a4').style.color = '#202020';
    document.getElementById('Rp3q1').value = 'a4';
}

function Rp3q2a1(){
    document.getElementById('Rp3q2a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q2a1').style.color = '#202020';
    document.getElementById('Rp3q2a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q2').value = 'a1';
}
function Rp3q2a2(){
    document.getElementById('Rp3q2a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q2a2').style.color = '#202020';
    document.getElementById('Rp3q2a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q2').value = 'a2';
}
function Rp3q2a3(){
    document.getElementById('Rp3q2a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q2a3').style.color = '#202020';
    document.getElementById('Rp3q2a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q2').value = 'a3';
}
function Rp3q2a4(){
    document.getElementById('Rp3q2a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q2a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q2a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q2a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q2a4').style.color = '#202020';
    document.getElementById('Rp3q2').value = 'a4';
}

function Rp3q3a1(){
    document.getElementById('Rp3q3a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q3a1').style.color = '#202020';
    document.getElementById('Rp3q3a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q3').value = 'a1';
}
function Rp3q3a2(){
    document.getElementById('Rp3q3a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q3a2').style.color = '#202020';
    document.getElementById('Rp3q3a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q3').value = 'a2';
}
function Rp3q3a3(){
    document.getElementById('Rp3q3a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q3a3').style.color = '#202020';
    document.getElementById('Rp3q3a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q3').value = 'a3';
}
function Rp3q3a4(){
    document.getElementById('Rp3q3a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q3a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q3a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q3a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q3a4').style.color = '#202020';
    document.getElementById('Rp3q3').value = 'a4';
}

function Rp3q4a1(){
    document.getElementById('Rp3q4a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q4a1').style.color = '#202020';
    document.getElementById('Rp3q4a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q4').value = 'a1';
}
function Rp3q4a2(){
    document.getElementById('Rp3q4a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q4a2').style.color = '#202020';
    document.getElementById('Rp3q4a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q4').value = 'a2';
}
function Rp3q4a3(){
    document.getElementById('Rp3q4a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q4a3').style.color = '#202020';
    document.getElementById('Rp3q4a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q4').value = 'a3';
}
function Rp3q4a4(){
    document.getElementById('Rp3q4a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q4a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q4a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q4a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q4a4').style.color = '#202020';
    document.getElementById('Rp3q4').value = 'a4';
}

function Rp3q5a1(){
    document.getElementById('Rp3q5a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q5a1').style.color = '#202020';
    document.getElementById('Rp3q5a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q5').value = 'a1';
}
function Rp3q5a2(){
    document.getElementById('Rp3q5a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q5a2').style.color = '#202020';
    document.getElementById('Rp3q5a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q5').value = 'a2';
}
function Rp3q5a3(){
    document.getElementById('Rp3q5a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q5a3').style.color = '#202020';
    document.getElementById('Rp3q5a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q5').value = 'a3';
}
function Rp3q5a4(){
    document.getElementById('Rp3q5a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q5a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q5a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q5a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q5a4').style.color = '#202020';
    document.getElementById('Rp3q5').value = 'a4';
}

function Rp3q6a1(){
    document.getElementById('Rp3q6a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q6a1').style.color = '#202020';
    document.getElementById('Rp3q6a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q6').value = 'a1';
}
function Rp3q6a2(){
    document.getElementById('Rp3q6a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q6a2').style.color = '#202020';
    document.getElementById('Rp3q6a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q6').value = 'a2';
}
function Rp3q6a3(){
    document.getElementById('Rp3q6a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q6a3').style.color = '#202020';
    document.getElementById('Rp3q6a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q6').value = 'a3';
}
function Rp3q6a4(){
    document.getElementById('Rp3q6a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q6a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q6a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q6a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q6a4').style.color = '#202020';
    document.getElementById('Rp3q6').value = 'a4';
}

function Rp3q7a1(){
    document.getElementById('Rp3q7a1').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q7a1').style.color = '#202020';
    document.getElementById('Rp3q7a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q7').value = 'a1';
}
function Rp3q7a2(){
    document.getElementById('Rp3q7a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a2').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q7a2').style.color = '#202020';
    document.getElementById('Rp3q7a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q7').value = 'a2';
}
function Rp3q7a3(){
    document.getElementById('Rp3q7a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a1').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a2').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a2').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a3').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q7a3').style.color = '#202020';
    document.getElementById('Rp3q7a4').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a4').style.color = '#F5F5DC';
    document.getElementById('Rp3q7').value = 'a3';
}
function Rp3q7a4(){
    document.getElementById('Rp3q7a1').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a1').style.color = '#F5F5DC';
    ...
    document.getElementById('Rp3q7a3').style.backgroundColor = '#202020';
    document.getElementById('Rp3q7a3').style.color = '#F5F5DC';
    document.getElementById('Rp3q7a4').style.backgroundColor = '#F5F5DC';
    document.getElementById('Rp3q7a4').style.color = '#202020';
    document.getElementById('Rp3q7').value = 'a4';
}
...
function checkResults(){
    ...
    if(document.getElementById('p1q7').value == 'a1'){
        all = all+1;
        list = list+1;
        document.getElementById('p1q7a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('p1q8').value == 'a3'){
        all = all+1;
        list = list+1;
        document.getElementById('p1q8a3r').style.backgroundColor = "#F5F5DC";
    }
    ...
    if(document.getElementById('Rp2q3').value == 'a4'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp2q3a4r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp2q4').value == 'a3'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp2q4a3r').style.backgroundColor = "#F5F5DC";
    }
    ...
    if(document.getElementById('Rp3q1').value == 'a3'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q1a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q2').value == 'a2'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q2a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q3').value == 'a1'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q3a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q4').value == 'a2'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q4a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q5').value == 'a1'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q5a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q6').value == 'a3'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q6a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q7').value == 'a1'){
        all = all+1;
        read = read+1;
        document.getElementById('Rp3q7a1r').style.backgroundColor = "#F5F5DC";
    }
...
function checkWrongResults(){
    ...
    if(document.getElementById('p1q6').value == 'a1'){
        document.getElementById('p1q6a1r').style.borderColor = "red";
        document.getElementById('p1q6a1r').style.color = "red";
    ...
    if(document.getElementById('p1q7').value == 'a2'){
        document.getElementById('p1q7a2r').style.borderColor = "red";
        document.getElementById('p1q7a2r').style.color = "red";
        document.getElementById('p1q7a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('p1q7').value == 'a3'){
        document.getElementById('p1q7a3r').style.borderColor = "red";
        document.getElementById('p1q7a3r').style.color = "red";
        document.getElementById('p1q7a3r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('p1q8').value == 'a1'){
        document.getElementById('p1q8a1r').style.borderColor = "red";
        document.getElementById('p1q8a1r').style.color = "red";
        document.getElementById('p1q8a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('p1q8').value == 'a2'){
        document.getElementById('p1q8a2r').style.borderColor = "red";
        document.getElementById('p1q8a2r').style.color = "red";
        document.getElementById('p1q8a2r').style.backgroundColor = "#F5F5DC";
    }


    if(document.getElementById('p2q1').value == 'a1'){
        document.getElementById('p2q1a1r').style.borderColor = "red";
        document.getElementById('p2q1a1r').style.color = "red";
    ...
    if(document.getElementById('p3q6').value == 'a3'){
        document.getElementById('p3q6a3r').style.borderColor = "red";
        document.getElementById('p3q6a3r').style.color = "red";
    ...
    if(document.getElementById('p3q7').value == 'a3'){
        document.getElementById('p3q7a3r').style.borderColor = "red";
        document.getElementById('p3q7a3r').style.color = "red";
    ...
    if(document.getElementById('Rp1q1').value == 'a4'){
        document.getElementById('Rp1q1a4r').style.borderColor = "red";
        document.getElementById('Rp1q1a4r').style.color = "red";
        document.getElementById('Rp1q1a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp1q2').value == 'a1'){
        document.getElementById('Rp1q2a1r').style.borderColor = "red";
        document.getElementById('Rp1q2a1r').style.color = "red";
    ...
    if(document.getElementById('Rp1q3').value == 'a3'){
        document.getElementById('Rp1q3a3r').style.borderColor = "red";
        document.getElementById('Rp1q3a3r').style.color = "red";
    ...
    if(document.getElementById('Rp1q4').value == 'a2'){
        document.getElementById('Rp1q4a2r').style.borderColor = "red";
        document.getElementById('Rp1q4a2r').style.color = "red";
    ...
    if(document.getElementById('Rp1q5').value == 'a4'){
        document.getElementById('Rp1q5a4r').style.borderColor = "red";
        document.getElementById('Rp1q5a4r').style.color = "red";
    ...
    if(document.getElementById('Rp1q7').value == 'a2'){
        document.getElementById('Rp1q7a2r').style.borderColor = "red";
        document.getElementById('Rp1q7a2r').style.color = "red";
    ...
    if(document.getElementById('Rp2q1').value == 'a2'){
        document.getElementById('Rp2q1a2r').style.borderColor = "red";
        document.getElementById('Rp2q1a2r').style.color = "red";
        document.getElementById('Rp2q1a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp2q1').value == 'a3'){
        document.getElementById('Rp2q1a3r').style.borderColor = "red";
        document.getElementById('Rp2q1a3r').style.color = "red";
        document.getElementById('Rp2q1a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp2q1').value == 'a4'){
        document.getElementById('Rp2q1a4r').style.borderColor = "red";
        document.getElementById('Rp2q1a4r').style.color = "red";
        document.getElementById('Rp2q1a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp2q2').value == 'a2'){
        document.getElementById('Rp2q2a2r').style.borderColor = "red";
        document.getElementById('Rp2q2a2r').style.color = "red";
        document.getElementById('Rp2q2a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp2q2').value == 'a3'){
        document.getElementById('Rp2q2a3r').style.borderColor = "red";
        document.getElementById('Rp2q2a3r').style.color = "red";
        document.getElementById('Rp2q2a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp2q2').value == 'a4'){
        document.getElementById('Rp2q2a4r').style.borderColor = "red";
        document.getElementById('Rp2q2a4r').style.color = "red";
        document.getElementById('Rp2q2a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp2q3').value == 'a1'){
        document.getElementById('Rp2q3a1r').style.borderColor = "red";
        document.getElementById('Rp2q3a1r').style.color = "red";
    ...
    if(document.getElementById('Rp2q3').value == 'a3'){
        document.getElementById('Rp2q3a3r').style.borderColor = "red";
        document.getElementById('Rp2q3a3r').style.color = "red";
        document.getElementById('Rp2q3a3r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp2q4').value == 'a1'){
        document.getElementById('Rp2q4a1r').style.borderColor = "red";
        document.getElementById('Rp2q4a1r').style.color = "red";
    ...
    if(document.getElementById('Rp2q4').value == 'a4'){
        document.getElementById('Rp2q4a4r').style.borderColor = "red";
        document.getElementById('Rp2q4a4r').style.color = "red";
        document.getElementById('Rp2q4a4r').style.backgroundColor = "#F5F5DC";
    }
    ...
    if(document.getElementById('Rp2q5').value == 'a3'){
        document.getElementById('Rp2q5a3r').style.borderColor = "red";
        document.getElementById('Rp2q5a3r').style.color = "red";
        document.getElementById('Rp2q5a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp2q5').value == 'a4'){
        document.getElementById('Rp2q5a4r').style.borderColor = "red";
        document.getElementById('Rp2q5a4r').style.color = "red";
        document.getElementById('Rp2q5a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp2q6').value == 'a1'){
        document.getElementById('Rp2q6a1r').style.borderColor = "red";
        document.getElementById('Rp2q6a1r').style.color = "red";
    ...
    if(document.getElementById('Rp2q6').value == 'a4'){
        document.getElementById('Rp2q6a4r').style.borderColor = "red";
        document.getElementById('Rp2q6a4r').style.color = "red";
        document.getElementById('Rp2q6a4r').style.backgroundColor = "#F5F5DC";
    }



    if(document.getElementById('Rp3q1').value == 'a1'){
        document.getElementById('Rp3q1a1r').style.borderColor = "red";
        document.getElementById('Rp3q1a1r').style.color = "red";
        document.getElementById('Rp3q1a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q1').value == 'a2'){
        document.getElementById('Rp3q1a2r').style.borderColor = "red";
        document.getElementById('Rp3q1a2r').style.color = "red";
        document.getElementById('Rp3q1a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q1').value == 'a4'){
        document.getElementById('Rp3q1a4r').style.borderColor = "red";
        document.getElementById('Rp3q1a4r').style.color = "red";
        document.getElementById('Rp3q1a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp3q2').value == 'a1'){
        document.getElementById('Rp3q2a1r').style.borderColor = "red";
        document.getElementById('Rp3q2a1r').style.color = "red";
        document.getElementById('Rp3q2a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q2').value == 'a3'){
        document.getElementById('Rp3q2a3r').style.borderColor = "red";
        document.getElementById('Rp3q2a3r').style.color = "red";
        document.getElementById('Rp3q2a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q2').value == 'a4'){
        document.getElementById('Rp3q2a4r').style.borderColor = "red";
        document.getElementById('Rp3q2a4r').style.color = "red";
        document.getElementById('Rp3q2a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp3q3').value == 'a2'){
        document.getElementById('Rp3q3a2r').style.borderColor = "red";
        document.getElementById('Rp3q3a2r').style.color = "red";
        document.getElementById('Rp3q3a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q3').value == 'a3'){
        document.getElementById('Rp3q3a3r').style.borderColor = "red";
        document.getElementById('Rp3q3a3r').style.color = "red";
        document.getElementById('Rp3q3a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q3').value == 'a4'){
        document.getElementById('Rp3q3a4r').style.borderColor = "red";
        document.getElementById('Rp3q3a4r').style.color = "red";
        document.getElementById('Rp3q3a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp3q4').value == 'a1'){
        document.getElementById('Rp3q4a1r').style.borderColor = "red";
        document.getElementById('Rp3q4a1r').style.color = "red";
        document.getElementById('Rp3q4a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q4').value == 'a3'){
        document.getElementById('Rp3q4a3r').style.borderColor = "red";
        document.getElementById('Rp3q4a3r').style.color = "red";
        document.getElementById('Rp3q4a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q4').value == 'a4'){
        document.getElementById('Rp3q4a4r').style.borderColor = "red";
        document.getElementById('Rp3q4a4r').style.color = "red";
        document.getElementById('Rp3q4a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp3q5').value == 'a2'){
        document.getElementById('Rp3q5a2r').style.borderColor = "red";
        document.getElementById('Rp3q5a2r').style.color = "red";
        document.getElementById('Rp3q5a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q5').value == 'a3'){
        document.getElementById('Rp3q5a3r').style.borderColor = "red";
        document.getElementById('Rp3q5a3r').style.color = "red";
        document.getElementById('Rp3q5a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q5').value == 'a4'){
        document.getElementById('Rp3q5a4r').style.borderColor = "red";
        document.getElementById('Rp3q5a4r').style.color = "red";
        document.getElementById('Rp3q5a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp3q6').value == 'a1'){
        document.getElementById('Rp3q6a1r').style.borderColor = "red";
        document.getElementById('Rp3q6a1r').style.color = "red";
        document.getElementById('Rp3q6a1r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q6').value == 'a2'){
        document.getElementById('Rp3q6a2r').style.borderColor = "red";
        document.getElementById('Rp3q6a2r').style.color = "red";
        document.getElementById('Rp3q6a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q6').value == 'a4'){
        document.getElementById('Rp3q6a4r').style.borderColor = "red";
        document.getElementById('Rp3q6a4r').style.color = "red";
        document.getElementById('Rp3q6a4r').style.backgroundColor = "#F5F5DC";
    }

    if(document.getElementById('Rp3q7').value == 'a2'){
        document.getElementById('Rp3q7a2r').style.borderColor = "red";
        document.getElementById('Rp3q7a2r').style.color = "red";
        document.getElementById('Rp3q7a2r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q7').value == 'a3'){
        document.getElementById('Rp3q7a3r').style.borderColor = "red";
        document.getElementById('Rp3q7a3r').style.color = "red";
        document.getElementById('Rp3q7a3r').style.backgroundColor = "#F5F5DC";
    }
    if(document.getElementById('Rp3q7').value == 'a4'){
        document.getElementById('Rp3q7a4r').style.borderColor = "red";
        document.getElementById('Rp3q7a4r').style.color = "red";
        document.getElementById('Rp3q7a4r').style.backgroundColor = "#F5F5DC";
    }
}
...
function RgoToPart2(){
    ...
    setTimeout(() => {
        ...
        document.getElementById('goToPart3Btn').style.display = 'block';
    }, 2200);
}
function RgoToPart3(){
    document.getElementById('loading2').style.display = 'flex';
    document.getElementById('goToPart3Btn').style.pointerEvents = 'none';
    setTimeout(() => {
        document.getElementById('loading2').style.opacity = '1';
        document.getElementById('loader2').style.animation = 'spin 0.8s linear infinite';
    }, 10);
    setTimeout(() => {
        ...
        document.getElementById('readingPart3').style.display = 'flex';
    }, 1000);
    setTimeout(() => {
        document.getElementById('loading2').style.opacity = '0';
    }, 2000);
    setTimeout(() => {
        document.getElementById('loading2').style.display = 'none';
        document.getElementById('loader2').style.animation = 'none';
        document.getElementById('goToPart3Btn').style.display = 'none';
        document.getElementById('goToPart3Btn').style.pointerEvents = 'all';
        document.getElementById('backToPart1Btn').style.display = 'none';
        document.getElementById('backToPart2Btn').style.display = 'block';
...
function RbackToPart2(){
    document.getElementById('loading2').style.display = 'flex';
    document.getElementById('backToPart2Btn').style.pointerEvents = 'none';
    ...
    setTimeout(() => {
        document.getElementById('readingPart3').style.display = 'none';
        document.getElementById('readingPart2').style.display = 'flex';
    }, 1000);
    setTimeout(() => {
        document.getElementById('loading2').style.opacity = '0';
    ...
    setTimeout(() => {
        document.getElementById('loading2').style.display = 'none';
        document.getElementById('loader2').style.animation = 'none';
        document.getElementById('backToPart2Btn').style.display = 'none';
        document.getElementById('backToPart2Btn').style.pointerEvents = 'all';
        document.getElementById('backToPart1Btn').style.display = 'block';
        document.getElementById('goToPart3Btn').style.display = 'block';
...
function submit(){
    ...
    setTimeout(() => {
        document.getElementById('submitPopup').style.opacity = '1';
    }, 10);
}
function cancelSubmit(){
    document.getElementById('submitPopup').style.opacity = '0';
    setTimeout(() => {
